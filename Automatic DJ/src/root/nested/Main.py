...
def getInput():
    ...
    for filename in filenames:
        try:
            inputList.append((audio.LocalAudioFile(filename).analysis.tempo['value'],
                              audio.LocalAudioFile(filename),filename))
...
"""
This method deletes the original input songs from the directory so they don't 
get copied into iTunes.
"""   
